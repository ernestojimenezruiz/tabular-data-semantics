...
public abstract class ColumnClassTypePredictor {
	 ...
	 */
	 public abstract Map<Integer, TreeMap<String,Double>> getClassTypesForTable(Table tbl, List<Integer> entity_columns) throws Exception;	
	 ...
	 * @throws Exception 
	 */
	public Map<Integer, TreeMap<String,Double>> getClassTypesForTable(Table tbl) throws Exception{
		return getClassTypesForTable(tbl, tbl.getColumnIndexesAsList());	
	}
	
	
	
	public abstract TreeMap<String,Double> getClassTypesForColumn(Column col) throws Exception;
