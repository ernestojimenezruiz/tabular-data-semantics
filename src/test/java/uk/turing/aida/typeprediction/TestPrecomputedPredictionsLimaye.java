 ...
 *
 */
public class TestPrecomputedPredictionsLimaye extends TestPrecomputedPredictions {
	...
	public TestPrecomputedPredictionsLimaye(EVAL_LEVEL eval_level, String predicted_types_file, double min_votes) throws Exception{
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (String file_name : ordered_files){
				...
				TestPrecomputedPredictionsLimaye  test_prediction;
				...
				if (file_name.endsWith(".csv")){
					...
					while (threshold<=1.0){
						...
						test_prediction = new TestPrecomputedPredictionsLimaye(eval_level, path + file_name, threshold); //default: 0.5, 1
